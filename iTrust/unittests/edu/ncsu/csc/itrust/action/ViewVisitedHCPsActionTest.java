...
public class ViewVisitedHCPsActionTest extends TestCase {
	...
	public void testGetVisitedHCPsRed() {
		...
		assertEquals("Lauren Frankenstein", beans.get(1).getHCPName());
		assertEquals("Jason Frankenstein", beans.get(2).getHCPName());
		assertEquals("Kelly Doctor", beans.get(3).getHCPName());
		assertEquals("Gandalf Stormcrow", beans.get(4).getHCPName());
	}
