 ...
 */
	...
	public Boolean submitResults(String id, String numericalResults, String upperBound, String lowerBound) throws FormValidationException {
			try {
				...
				lpDAO.submitTestResults(Long.parseLong(id), numericalResults, upperBound, lowerBound);
