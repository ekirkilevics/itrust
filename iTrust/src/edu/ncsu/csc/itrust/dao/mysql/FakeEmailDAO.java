...
/**
 * Subsitutes for actually sending emails (since we don't want to train little spammers in 326). Just inserts
 * stuff into a database and returns it.
 * 
...
public class FakeEmailDAO {
	 ...
	 * @throws DBException
	 */
	public List<Email> getAllFakeEmails() throws DBException {
	 ...
	 * @throws DBException
	 */
	public List<Email> getFakeEmailsByPerson(String email) throws DBException {
		Connection conn = null;
		PreparedStatement ps = null;
		try {
			conn = factory.getConnection();
	 ...
	 * @throws DBException
	 */
	public void sendFakeEmail(Email email) throws DBException {
		Connection conn = null;
		PreparedStatement ps = null;
		try {
			conn = factory.getConnection();
