...
public class LabProcedureBean {
	 ...
	 * The number may have an optional sign, then one of the following formats:
	 * 		DIGIT+				(one or more digits)
	 *      DIGIT+ . DIGIT*		(one or more digits, a decimal point, and zero or more digits)
	 *      . DIGIT+			(a decimal point and one or more digits)
	 */
	private String numericalResult = "";
	 
	 /**
	 * The upper bound of the confidence interval.  This follows the same 
	 * format as numericalResult.
	 */
	private String upperBound = "";
	 
	 /**
	 * The lower bound of the confidence interval.  This follows the same 
	 * format as numericalResult.
	 */
